...
from datafuncs import ImageFolderWithRatings, get_subset
...
class AuDrADataModule(pl.LightningDataModule):
    def __init__(self, args, data_dir = 'primary_images/', ratings_path = 'primary_ratings_zscored.csv'):
        super().__init__()
    ...
    def test_dataloader(self):
        return DataLoader(self.test_set, batch_size = self.args.batch_size, drop_last = True, num_workers = 20)


## Get the mean/sd for each of the channels across the stim set
